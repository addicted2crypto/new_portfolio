        ...
        <section
            ...
            >
                ...
                >
                    ...
                    <a className='group bg-gray-50 px-7 py-3 flex items-center gap-2 rounded-e-full underline outline-none focus:scale-110 hover:scale-110 dark:bg-white/10 dark:text-white/80' href="/0802resume.pdf" download>
                        Download resume
