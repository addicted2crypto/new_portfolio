...
const BOOT: Raw[] = [
  ...
  { type: 'pair',      text: 'Role  ', sub: 'AI & Full-Stack Engineer · LLM Pipelines · Security+' },
...
const CMDS: Record<string, Raw[]> = {
  ...
  projects: [
    ...
    { type: 'pair',    text: 'AvaSleuth ', sub: 'Local AI stack applied to AVAX security (private build)' },
    { type: 'pair',    text: 'DCGP      ', sub: 'Live context governance kernel for local LLM dev' },
    { type: 'pair',    text: 'WillAgent ', sub: 'Local model orchestration · Ollama + Claude routing' },
    { type: 'pair',    text: 'hCASH     ', sub: 'Live · Chainlink oracle ROI calculator on AVAX mainnet' },
    { type: 'pair',    text: 'Moat OCA  ', sub: 'Live · on-chain portfolio leaderboard vs AVAX/BTC' },
